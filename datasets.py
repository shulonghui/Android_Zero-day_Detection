...
def build_transform(is_train, args):
    ...
    if is_train:
        ...
        transform = create_transform(
            ...
            auto_augment=args.aa,#自动增强
            interpolation=args.train_interpolation,#插值方式
            re_prob=args.reprob,#随机擦除概率
            re_mode=args.remode,#随机擦除模式
            re_count=args.recount,#随机擦除计数
        )
        if not resize_im:
   ...
   #t.append(transforms.Normalize(0.47759387, 0.2188971))
    #Mean: 0.47759387 ,Std: 0.2188971
